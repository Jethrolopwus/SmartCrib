    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-lg sm:text-xl text-gray-200 mb-8 max-w-2xl mx-auto leading-relaxed">
          SmartCribs connects renters with homeowners through secure, transparent blockchain-powered transactions. 
          Experience the future of real estate with trustless interactions and verifiable reviews.
        </p>
